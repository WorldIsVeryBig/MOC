...
def get_info(event):
    ...
    print(data)
    result = Create_Img(time=data['Time'], interface=data['Interface'], tempo_name=data['Tempo_name'])
...
def interface_change(event):
    result = Create_Img(time=time_combobox.get(), interface=interface_combobox.get(), tempo_name=tempo_name_combobox.get())
    result.draw_result_img()
    

    print(time_combobox.get(), interface_combobox.get(), tempo_name_combobox.get())
    photo = tk.PhotoImage(file="output.png")
    imgLabel = tk.Label(root, image=photo)
    imgLabel.place(x=24, y=125)
# 設置主畫面
...
# 設置時間下拉條
time_combobox_list = ['2020/01/26 15:30:00 - 2020/01/26 15:40:00', '2020/01/26 15:30:00 - 2020/01/26 15:40:00', '2020/01/26 15:30:00 - 2020/01/26 15:40:00', '2020/01/26 15:30:00 - 2020/01/26 15:40:00', '2020/01/26 15:30:00 - 2020/01/26 15:40:00']
